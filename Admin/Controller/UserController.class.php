...
//        $image_path =IMGS_URL.'bg.jpg';   //http://wechat.official.mmt/Public/Home/imgs/bg.jpg
        $image_path = './'.IMGS_URL.'404.jpg';  //  http://wechat.official.mmt/Public/Home/imgs/404.jpg
//        $image_path ='./2017yiqixiu.png';
     //   var_dump($image_path);exit;
        $image_deal->open($image_path);
        var_dump($image_deal);
    }
