<?php /* Smarty version Smarty-3.1.6, created on 2017-01-18 18:37:32
...
">
    <div class="content" style="text-align: center;">
        <label class="con-title">星座物语</label></br>

        <input placeholder="请输入出生月份(阳历)"  class="txt-birth" type="text"   name="txtBirth" /><br/>
        <input placeholder="请输入出生月份(阳历)"   class="txt-birthday" type="text"   name="txtBirthday" /><br/>
